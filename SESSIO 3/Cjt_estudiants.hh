...
public:
  ...
  /* Post: si b=true, s?ha modificat l?estudiant est al parametre implicit */
  ...
  void consultar_estudiant(bool& b, Estudiant& est) ;
  /* Pre: no se si existeix un estudiant al parametre implícit amb DNI = dni */
  /* Post:  si b=true, el resultat es l'estudiant amb DNI = dni que conte el
     parametre implicit */
