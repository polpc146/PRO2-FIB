...
Definición en la línea 180 del archivo Terminal\+De\+Contenedores\+De\+Carga.\+cc.


\begin{DoxyCode}
180                                                                         \{
181     
182     \textcolor{keywordflow}{if} (u.\hyperlink{class_ubicacion_af6099f8de4dee993e4c9119e1f879070}{piso}() < \hyperlink{class_terminal_ad6cdee7fe26b4443d45b0a18c345a86d}{num\_pisos} - 1) \{
183         
184         \textcolor{keywordtype}{int} i = u.\hyperlink{class_ubicacion_abf00d08075e75ac833de7357ebc6f521}{hilera}();
185         \textcolor{keywordtype}{int} j = \hyperlink{class_terminal_ad6cdee7fe26b4443d45b0a18c345a86d}{num\_pisos} - 2 - u.\hyperlink{class_ubicacion_af6099f8de4dee993e4c9119e1f879070}{piso}();
186         \textcolor{keywordtype}{int} k = u.\hyperlink{class_ubicacion_abed323ffb2eace375e80bc395fdaeb39}{plaza}() + 2;
187         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} x = 0; x < l; ++x) \{
188         
189             \textcolor{keywordflow}{if} (\hyperlink{class_terminal_a50670862a5cdeb0504efd1c45b6416dc}{AreaDeAlmacenaje}[i][j][k] != \textcolor{stringliteral}{" "}) \{
190                 
191                 \hyperlink{class_ubicacion}{Ubicacion} u2 (u.\hyperlink{class_ubicacion_abf00d08075e75ac833de7357ebc6f521}{hilera}(), u.\hyperlink{class_ubicacion_abed323ffb2eace375e80bc395fdaeb39}{plaza}() + x, u.
      \hyperlink{class_ubicacion_af6099f8de4dee993e4c9119e1f879070}{piso}() + 1);
192                 \textcolor{keywordtype}{string} s = \hyperlink{class_terminal_a50670862a5cdeb0504efd1c45b6416dc}{AreaDeAlmacenaje}[i][j][k];
193                 \hyperlink{class_segmento}{Segmento} seg = \hyperlink{class_terminal_a1d87d7b16c4f460eee6f1ab73da90fd2}{almacenaje}.\hyperlink{class_almacenaje_afe08e4bca255d4baf3750019622e6cb2}{donde} (s);
194                 \hyperlink{class_terminal_aeadd54221b7138f6b1b4e7d072723ffa}{piso\_superior} (seg.\hyperlink{class_segmento_aeb7bfd4dcac3a1a000a33582861e0d50}{ubic}(), seg.\hyperlink{class_segmento_a61c7347eb37045bef7655d3db24d7fd9}{longitud}(), m);
195             \}
196             ++k;
197         \}
198     \}
199     \textcolor{keywordtype}{string} mat = \hyperlink{class_terminal_a50670862a5cdeb0504efd1c45b6416dc}{AreaDeAlmacenaje}[u.\hyperlink{class_ubicacion_abf00d08075e75ac833de7357ebc6f521}{hilera}()][\hyperlink{class_terminal_ad6cdee7fe26b4443d45b0a18c345a86d}{num\_pisos} - 1 - u.
...
285                                                   \{
286     
287     \hyperlink{class_segmento}{Segmento} s = \hyperlink{class_terminal_a1d87d7b16c4f460eee6f1ab73da90fd2}{almacenaje}.\hyperlink{class_almacenaje_afe08e4bca255d4baf3750019622e6cb2}{donde}(m);
288     \hyperlink{class_ubicacion}{Ubicacion} uesp(-1,0,0);
289     \textcolor{keywordtype}{int} l = s.\hyperlink{class_segmento_a61c7347eb37045bef7655d3db24d7fd9}{longitud}();
290     \textcolor{keywordflow}{if} (s.\hyperlink{class_segmento_aeb7bfd4dcac3a1a000a33582861e0d50}{ubic}() == uesp) \{
291         
292         \hyperlink{class_contenedor}{Contenedor} c (m, l);
293         \hyperlink{class_terminal_ac9f71207d73c8d05a9d9d6c046f9f8c3}{espera}.\hyperlink{class_espera_a925d1944461d0e9bedef4d788283b98f}{eliminar\_contenedor}(c);
294     \}
295     \textcolor{keywordflow}{else} \{
296         
297         \hyperlink{class_ubicacion}{Ubicacion} u = s.\hyperlink{class_segmento_aeb7bfd4dcac3a1a000a33582861e0d50}{ubic}();
298         \textcolor{keywordflow}{if} (u.\hyperlink{class_ubicacion_af6099f8de4dee993e4c9119e1f879070}{piso}() < \hyperlink{class_terminal_ad6cdee7fe26b4443d45b0a18c345a86d}{num\_pisos} - 1) \{
299             
300             \hyperlink{class_terminal_aeadd54221b7138f6b1b4e7d072723ffa}{piso\_superior} (u, l, m);
301         \}
302         \textcolor{keywordtype}{int} i = u.\hyperlink{class_ubicacion_abf00d08075e75ac833de7357ebc6f521}{hilera}();
303         \textcolor{keywordtype}{int} j = \hyperlink{class_terminal_ad6cdee7fe26b4443d45b0a18c345a86d}{num\_pisos} - 1 - u.\hyperlink{class_ubicacion_af6099f8de4dee993e4c9119e1f879070}{piso}();
304         \textcolor{keywordtype}{int} k = u.\hyperlink{class_ubicacion_abed323ffb2eace375e80bc395fdaeb39}{plaza}() + 2;
305         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} x = 0; x < l; ++x) \{
306         
307             \hyperlink{class_terminal_a50670862a5cdeb0504efd1c45b6416dc}{AreaDeAlmacenaje}[i][j][k] = \textcolor{stringliteral}{" "};
308             ++k;
309         \}
310         \hyperlink{class_terminal_a56204987306ed811046d3ade11fff2cb}{buscar\_huecos\_r} (u, l);
311         \textcolor{keywordflow}{if} (\hyperlink{class_terminal_ac9f71207d73c8d05a9d9d6c046f9f8c3}{espera}.\hyperlink{class_espera_ae97d5ed76fdcf057835b51a87deaffb9}{hay\_contenedores}()) \{
312             
313             \hyperlink{class_terminal_a672932def16149bd23a95d60956e42a0}{insertar\_AreaDeEspera}();
314         \}
315     \}
316     \hyperlink{class_terminal_a1d87d7b16c4f460eee6f1ab73da90fd2}{almacenaje}.\hyperlink{class_almacenaje_aa4a16321fcfba32873521b9af6c8b73a}{retirar\_contenedor} (m);
317 \}
\end{DoxyCode}
